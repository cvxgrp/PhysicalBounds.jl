...
function postprocess(content)
      """
      The source files for all examples can be found in [/examples](https://github.com/cvxgrp/PhysicalBounds.jl/tree/main/examples).
      """ * content
end
...
makedocs(;
    modules=[PhysicalBounds],
    authors="Guillermo Angeris, Theo Diamandis",
    repo="https://github.com/cvxgrp/PhysicalBounds.jl/blob/{commit}{path}#L{line}",
    sitename="PhysicalBounds.jl",
    format=Documenter.HTML(;
        prettyurls=get(ENV, "CI", "false") == "true",
        canonical="https://github.com/cvxgrp/PhysicalBounds.jl",
        assets=String[],
    ),
    pages=[
        "Home" => "index.md",
...
deploydocs(;
    repo="github.com/cvxgrp/PhysicalBounds.jl",
    devbranch = "main"
)